...
pureButton.addEventListener('click', startPureTrivia)
salahButton.addEventListener('click', startSalahTrivia)
...
//Start Purfication trivia
    function startPureTrivia() {
    allButton.classList.add('hide')
    chooseFiqhButton.classList.add('hide')
    shuffledQuestions = pureQuestions.sort(() => Math.random() - .5)
...
//Start Salah trivia
    function startSalahTrivia() {
    allButton.classList.add('hide')
    chooseFiqhButton.classList.add('hide')
    shuffledQuestions = salahQuestions.sort(() => Math.random() - .5)
    currentQuestionIndex = 0
    questionContainerElement.classList.remove('hide')
    setNextQuestion()
  }
  ...
  //Start Zakat trivia
    function startZakatTrivia() {
    allButton.classList.add('hide')
    chooseFiqhButton.classList.add('hide')
    shuffledQuestions = zakatQuestions.sort(() => Math.random() - .5)
    currentQuestionIndex = 0
    questionContainerElement.classList.remove('hide')
    setNextQuestion()
  }

  //Start Fasting trivia
    function startFastingTrivia() {
    allButton.classList.add('hide')
    chooseFiqhButton.classList.add('hide')
    shuffledQuestions = fastingQuestions.sort(() => Math.random() - .5)
    currentQuestionIndex = 0
    questionContainerElement.classList.remove('hide')
    setNextQuestion()
  }
